...
import { ClipboardList, Home, LogOut, MessageSquare, Users } from 'lucide-react'
    ...
    <div className="dev-detail">
      ...
      <section className="dev-detail__section">
        <div className="dev-detail__row dev-detail__row--between">
          <h3 className="dev-detail__section-title">მომხმარებლისთვის მოქმედება</h3>
          <button
            type="button"
          ...
          >
            ...
            {showChat ? 'დამალვა' : 'მოქმედებების ჩვენება'}
          </button>
        </div>
